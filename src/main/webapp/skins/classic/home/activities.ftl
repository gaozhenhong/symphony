                                ...
                                <li>
                                    <div class='fn-flex'>
                                        ...
                                        <div class="fn-flex-1">
                                            ...
                                            <span class="ft-fade content-reset">
                                                领取昨日 <a href="http://183.224.44.44:8088/article/1458624687933" rel="nofollow" class="ft-gray">活跃度奖励</a> ，目前最高可以获得 <code>${activitYesterdayLivenessRewardMaxPoint?c}</code>
                                            </span>
                                        </div>
                                    </div>
                                </li>
