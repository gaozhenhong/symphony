                                        ...
                                        <div class="fn-flex-1">
                                            <div class="fn-clear comment-info ft-smaller">
                                                <span class="fn-left">
                                                    ...
                                                    <a rel="nofollow" class="ft-green" href="http://183.224.44.44:8088/article/1457158841475">API</a>
                                                    </#if>
            ...
            <div class="side wrapper">
                ...
                <div class="module">
                    <div class="module-header">
                        <h2>
                            ${sponsorLabel} 
                            <a href="http://183.224.44.44:8088/article/1460083956075" class="fn-right ft-13 ft-gray" target="_blank">${wantPutOnLabel}</a>
                        </h2>
                    </div>
